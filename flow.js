// Functional prototype for the Flow discussion system
// 
// @author: Grant Dickie
// @email: jgrantd@gmail.com
		...
		},
		{
			...
			"responses" : [
				...
				{ 
		 			...
		 			"age": "82082",
		 			"author": "Burkehart",
		 			"posttext": "<p>THE STATEMENT ABOVE BY Johnpacklambert is incorrect (although he may be unaware of this). Amy Tan was removed from â€œAmerican novelistsâ€ on 13 September last year (and put into the category â€œAmerican novelists of Asian descentâ€) and added to â€œAmerican women novelistsâ€ by a different editor on 24 March. Here are the dates of these two edits: http://en.wikipedia.org/w/index.php?title=Amy_Tan&diff=next&oldid=510787230 http://en.wikipedia.org/w/index.php?title=Amy_Tan&diff=next&oldid=543063880 â€” Preceding <a>unsigned</a> comment added by </p>"
				},
				{ 
		...
		},
		{
			...
			"responses" : [
				...
				{ 
		 			...
		 			"age": "496322",
		 			"author": "JohnClarknew",
		 			"posttext": "<p>The Society is indeed the foremost authority on the creation of <a>Richmal Crompton</a>'s loveable rascal. They meet once a year, and online. The magazine can be obtained for Â£10, and there's no need to participate in any activity. Back copies for Â£3.50, members only, and they exist barely as a non-profit, just like WP. They could do with donations too! I and <a>Martin Jarvis</a> who is famous for reading the stories on BBC radio and audiobooks, are honorary members, and we feel honored to have been asked. </p>"
				},
				{ 
...
(function($) {
	// Passing in #id of main discussion area where HTML will be set up
	...
	$(document).ready(function() {
		var f = flow("#main");
		f.getData('http://unicorn.wmflabs.org/techtask/discussion.json');
	});
})(jQuery);